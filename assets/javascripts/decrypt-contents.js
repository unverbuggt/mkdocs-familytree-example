...
function decrypt_action(password_input, encrypted_content, decrypted_content, key_from_storage, username_input) {
    ...
    if (content !== false) {
        ...
        let reload_scripts = ['#familytree-data', '#familytree-lang', '#theme'];
...
function decryptor_reaction(key_or_keys, password_input, fallback_used=false) {
    ...
    if (key_or_keys) {
        ...
        let encrypted_something = {'myNav': ['div', 'id'], 'myToc': ['div', 'id'], 'myTocButton': ['div', 'id'], 'title-top': ['span', 'id'], 'title-head': ['span', 'id']};
